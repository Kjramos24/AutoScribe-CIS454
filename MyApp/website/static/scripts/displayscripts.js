...
//All page functions
function toggleUserContent() { //Toggle "Hello User Menu"
...
//Scrtipts for homepage.html------------------------------------------------------------------------
function setSearchCount(opp){ //Use buttons to increase and decrease number
  //getting current value
  if(document.getElementById("search-input").value === "" || isNaN(parseInt(document.getElementById("search-input").value))){ 
    //if input is empty or invalid input (not a number)
    curr = parseInt(document.getElementById("search-input").placeholder); //start with place holder (0)
  }
  else{
    curr = parseInt(document.getElementById("search-input").value); // start with user value
  }

  //actual adding and substract
  if(opp === 'add'){
    curr = curr + 1;
  }
  else if (curr > 0){
  ...
  document.getElementById("search-input").value = curr;
}
